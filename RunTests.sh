...
th TrainStudentModel.lua "/home/jshen/models/VGG/VGG_ILSVRC_16_layers.caffemodel ImagenetProcessor.lua" "/tmp/test.t7 ImagenetProcessor.lua" /file1/imagenet/ILSVRC2012_img_val /tmp/test.t7 -epochs 1 -epochSize 1
