...
th /home/jshen/scripts/Forward.lua /tmp/test.t7 /file/caltech/val/base /home/jshen/scripts/CaltechHOGLUV.lua -processorOpts "-imageSize 227 -windowSizeX 320 -windowSizeY 240 -windowScales 0" -epochSize 1 -batchSize 3 -nGPU 1 -nThreads 4
