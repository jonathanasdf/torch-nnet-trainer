...
th /home/jshen/scripts/Train.lua /home/jshen/models/AlexNet_ped/caltech10x_warp_finetune.caffemodel "/file/caltech/train/{pos/base,pos/IOU0.5,neg/base,neg/IOU0.5}/base" /tmp/test.t7 /home/jshen/scripts/CaltechProcessor.lua -processorOpts "-imageSize 227 -windowHeight 480 -windowScales 1" -val /file/caltech/val/base -valBatchSize 3 -valSize 1 -valEvery 1 -epochs 1 -epochSize 1 -nGPU 1 -nThreads 0
...
th /home/jshen/scripts/Forward.lua /tmp/test.t7 /file/caltech/val/base /home/jshen/scripts/CaltechProcessor.lua -processorOpts "-imageSize 227 -windowHeight 480 -windowScales 1" -epochSize 1 -batchSize 3 -nGPU 1 -nThreads 1
...
th /home/jshen/scripts/Forward.lua /tmp/test.t7 /file/caltech/val/base /home/jshen/scripts/CaltechProcessor.lua -processorOpts "-imageSize 227 -windowHeight 480 -windowScales 1" -epochSize 1 -batchSize 3 -nGPU 1 -nThreads 4
...
th /home/jshen/scripts/Forward.lua /tmp/test.t7 /file/caltech/val/base /home/jshen/scripts/CaltechProcessor.lua -processorOpts "-svm /tmp/test_svm.t7 -layer fc7 -imageSize 227 -windowHeight 480 -windowScales 1" -epochSize 1 -batchSize 3 -nGPU 1 -nThreads 1
th /home/jshen/scripts/Forward.lua /tmp/test.t7 /file/caltech/val/base /home/jshen/scripts/CaltechProcessor.lua -processorOpts "-svm /tmp/test_svm.t7 -layer fc7 -imageSize 227 -windowHeight 480 -windowScales 1" -epochSize 1 -batchSize 3 -nGPU 1 -nThreads 8
...
th /home/jshen/scripts/TrainStudentModel.lua /home/jshen/models/AlexNet_ped/caltech10x_warp_finetune.caffemodel /home/jshen/models/VGG/vggbn_10channels_2outputs.lua "/file/caltech/train/{pos/base,pos/IOU0.5,neg/base,neg/IOU0.5}/base" /tmp/test.t7 /home/jshen/scripts/CaltechHOGLUV.lua -processorOpts "-imageSize 224 -windowHeight 480 -windowScales 1" -teacherProcessor /home/jshen/scripts/CaltechProcessor.lua -teacherProcessorOpts "-imageSize 227" -val /file/caltech/val/base -valSize 1 -valBatchSize 3 -valEvery 1 -epochs 1 -epochSize 1 -LR 0.01 -nGPU 1 -nThreads 0
...
th /home/jshen/scripts/Forward.lua /tmp/test.t7 /file/caltech/val/base /home/jshen/scripts/CaltechHOGLUV.lua -processorOpts "-imageSize 227 -windowHeight 480 -windowScales 1" -epochSize 1 -batchSize 3 -nGPU 1 -nThreads 4
...
if (($nGPU >= 2)); then
  ...
  th /home/jshen/scripts/TrainStudentModel.lua /home/jshen/models/AlexNet_ped/caltech10x_warp_finetune.caffemodel /home/jshen/models/SqueezeNet/squeezenet.lua "/file/caltech/train/{pos/base,pos/IOU0.5,neg/base,neg/IOU0.5}/base" /tmp/test.t7 /home/jshen/scripts/CaltechProcessor.lua -processorOpts "-imageSize 227 -windowHeight 480 -windowScales 1" -val /file/caltech/val/base -valSize 2 -valBatchSize 3 -valEvery 1 -epochs 1 -epochSize 2 -LR 0.01 -nGPU 2 -nThreads 2
  th /home/jshen/scripts/Forward.lua /tmp/test.t7 /file/caltech/val/base /home/jshen/scripts/CaltechProcessor.lua -processorOpts "-imageSize 227 -windowHeight 480 -windowScales 1" -epochSize 2 -batchSize 3 -nGPU 2 -nThreads 2
  ...
  th /home/jshen/scripts/Forward.lua /tmp/test.t7 /file/caltech/val/base /home/jshen/scripts/CaltechProcessor.lua -processorOpts "-imageSize 227 -windowHeight 480 -windowScales 1" -epochSize 2 -batchSize 3 -nGPU 2 -nThreads 8
  
  # Caltech train, forward replicateModel
  th /home/jshen/scripts/Train.lua /home/jshen/models/SqueezeNet/squeezenet.lua "/file/caltech/train/{pos/base,pos/IOU0.5,neg/base,neg/IOU0.5}/base" /tmp/test.t7 /home/jshen/scripts/CaltechProcessor.lua -processorOpts "-imageSize 227 -windowHeight 480 -windowScales 1" -val /file/caltech/val/base -valSize 2 -valBatchSize 3 -valEvery 1 -epochs 1 -epochSize 2 -nGPU 2 -nThreads 4 -replicateModel
  th /home/jshen/scripts/Forward.lua /tmp/test.t7 /file/caltech/val/base /home/jshen/scripts/CaltechProcessor.lua -processorOpts "-imageSize 227 -windowHeight 480 -windowScales 1" -epochSize 2 -batchSize 3 -nGPU 2 -nThreads 4 -replicateModel
fi
