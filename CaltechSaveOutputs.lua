...
function M:test(pathNames)
  ...
  for i=1,#pathNames do
     torch.save('/file1/caltech10x/teacheroutputs64/' .. paths.basename(pathNames[i], '.png') .. 'fc.t7',
                 self.model:get(15).output[i])
     torch.save('/file1/caltech10x/teacheroutputs64/' .. paths.basename(pathNames[i], '.png') .. '.t7',
